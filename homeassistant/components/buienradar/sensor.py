...
ICON_MDI_WEATHER_PARTLY_CLOUDY = "mdi:weather-partly-cloudy"
ICON_MDI_WEATHER_CLOUDY = "mdi:weather-cloudy"
ICON_MDI_WEATHER_RAINY = "mdi:weather-rainy"
ICON_MDI_WEATHER_SUNNY = "mdi:weather-sunny"
...
SENSOR_TYPES: tuple[SensorEntityDescription, ...] = (
    ...
    SensorEntityDescription(
        ...
        native_unit_of_measurement=PERCENTAGE,
        icon=ICON_MDI_WEATHER_PARTLY_CLOUDY,
    ),
    SensorEntityDescription(
        key="sunchance_2d",
